...
namespace JuliusSweetland.OptiKey.UI.Controls
{
    ...
    /// </summary>
    public partial class ExperimentalOutput2 : UserControl
    {
        public ExperimentalOutput2()
        {
            InitializeComponent();
        ...
        public static readonly DependencyProperty NumberOfSuggestionsDisplayedProperty =
            DependencyProperty.Register("NumberOfSuggestionsDisplayedExperimental", typeof (int), typeof (ExperimentalOutput2), new PropertyMetadata(default(int)));
        ...
        public static readonly DependencyProperty ScratchpadWidthInKeysProperty = DependencyProperty.Register(
            "ScratchpadWidthInKeysExperimental", typeof (int), typeof (ExperimentalOutput2), new PropertyMetadata(default(int)));
